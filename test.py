...
#jp_corrector = BertForMaskedLMPL.load_from_checkpoint('models/split.bak/replacement/epoch=2-step=66036.ckpt')
jp_corrector = BertForMaskedLMPL.load_from_checkpoint('models/split/replacement/epoch=2-step=67935.ckpt')
...
with open('./data/split/test_replacement.jsonl') as fp:
    ...
    for row in fp:
        ...
        with torch.no_grad():
            scores = jp_corrector.bert_mlm(**bert_input).logits
